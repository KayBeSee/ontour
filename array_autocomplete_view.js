...
var defaultTemplate = [
    '<div>',
        ...
        '<a data-hook="add-field" class="add-input">add artist</a>',
...
module.exports = View.extend({
    initialize: function (spec) {
        ...
        this.idAttribute = spec.idAttribute;
        this.queryKey = spec.queryKey;
        this.textAttribute = spec.textAttribute;
        this.minKeywordLength = spec.minKeywordLength;
    ...
    addField: function (value) {
        ...
        var field = new AutoCompleteView(initOptions);
